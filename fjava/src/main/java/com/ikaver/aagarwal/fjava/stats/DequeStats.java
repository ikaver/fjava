...
public class DequeStats {
  ...
  public DequeStats(int idx) {
    this.totalSteals = new MonitoredCounter(
        StatsTracker.getStatisticName("deque.steals", "", idx),
        "# of total steals");
    ...
    this.dequeEmpty = new MonitoredCounter(
        StatsTracker.getStatisticName("deque.was_empty", "", idx),
        "# of total times the deque was empty on getTask");
    this.dequeNotEmpty = new MonitoredCounter(
        StatsTracker.getStatisticName("deque.not_empty", "", idx),
        "# of total times the deque was not empty on getTask");
    this.dequeGetTask = new MonitoredCounter(
        StatsTracker.getStatisticName("deque.get_task", "", idx),
        "# of total times getTask is called");
    
    this.acquiredTime = new MonitoredCounter(
        StatsTracker.getStatisticName("deque.time.acquire", "", idx),
        "Time spent on acquire");
  }
